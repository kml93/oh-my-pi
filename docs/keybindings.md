...
| `app.approval.cycle`         | Unbound                                                               | Cycle the session-only tool approval mode; unavailable when `--yolo` or `--auto-approve` locks the session                                                                           |
| `app.settings.open`          | `Alt+S`                                                               | Open the settings selector                                                                                                                                                           |
